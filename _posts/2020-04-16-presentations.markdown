...
layout: post
active: Blog
ptitle:  "Guidelines I follow when giving talks" 
categories: misc
...
<a class="thumb" href=""><img src="{{ site.baseurl }}/img/YouTubeTalks.png" class="img-responsive" alt="Videos of talks I've given on YouTube"></a>
