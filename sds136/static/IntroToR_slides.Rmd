...
- [new to R and RStudio](static/IntroToR_slides.html#(2))
- [new to ggplot2](static/IntroToR_slides.html#(14))
- [new to plotly API](static/IntroToR_slides.html#(45))
- [sorting, filtering](static/IntroToR_slides.html#(51))
- [working with dates](static/IntroToR_slides.html#(74))
...
I've had our server administrator make you all RStudio server accounts. To log in, go to [rstudio.smith.edu](rstudio.smith.edu) and log in with your Smith username (mine is amcnamara) and the same password you use for Bannerweb, your email, etc. 

## RStudio 
RStudio is a great interface to the R language. The interface has 4 panes. 


<img src="rstudiopanes.png" width="500px" />
...
If you want to see the plots online, you will need to set up your API credentials in R. Read about that [here](https://plot.ly/r/getting-started/). You need to fill in your username and API key
...
There is much more documentation about these functions [online](https://plot.ly/r/).
