...
require(mosaic)
softball = c(3,2,6,0,1,1,0,3,2,2,1,1,1,3,2,4,12,3,15,0,2,0,4,3,2,1,1,1,0,1)
basketball = c(90,80,63,71,70,73,74,68,77,82,82,63,95,50,63,58,65,74,53,79,71,71,52,76,65,61)
# mean(basketball)
# var(basketball)
@
