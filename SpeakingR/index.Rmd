...
[`r icons::fontawesome("twitter")` @AmeliaMN](https://twitter.com/AmeliaMN)  
[`r icons::fontawesome("github")` AmeliaMN](www.github.com/AmeliaMN)  
...
---
class: big-bullet
## `r icons::fontawesome("chalkboard-teacher")` How to teach programming (and other things)
...
### `r icons::fontawesome("award")` Teach the most useful thing first 
### `r icons::fontawesome("brain")` Reduce cognitive load 
### `r icons::fontawesome("keyboard")` Don't touch the learner's keyboard 
### `r icons::fontawesome("volume-up")` Verbalize what you are doing 
